0x08. Python - More Classes and Objects this is the new project for the day

about classes and objects 
we learn about OOP in Python
...
of the rectangle to be able to recreate a new instance by using eval() (see example below)
